...
% in the abstract
\begin{abstract}
Software projects are hard to deliver and significant part of the complexity comes from the severity of reasoning about the correctness of the product. This hardness is twofold: \textit{a) how to define the requirements} and \textit{b) how to proof the compliance of implementation to specification}.

In this paper a solution with its implementation is described, which is based on a popular approach to deal with these problems: \textit{Behavior Driven Development (BDD)}.

In this paper it will be described how the Gherkin grammar is extended and defined, how it is linked to the development process.

Furthermore it is described how the specification process is defined and explained why and how it is cost effective while focusing on the business value.
...
% no keywords
\keywords{evolutionary process; BDD; software testing; Gherkin; Annotated Gherkin}
